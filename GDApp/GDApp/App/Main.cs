...
namespace GDApp
{
    public class Main : Microsoft.Xna.Framework.Game
    {
        ...
        private void LoadCurvesAndRails()
        {
            ...
            curveA.Add(new Vector3(0, 0, 60), -Vector3.UnitZ, Vector3.UnitY, 0); //start position
            //add more points and make the camera point in other directions here...
            curveA.Add(new Vector3(0, 20, 0), -Vector3.UnitY, -Vector3.UnitZ, 8); //curve mid-point
            //add more points and make the camera point in other directions here...
            curveA.Add(new Vector3(0, 0, 60), -Vector3.UnitZ, Vector3.UnitY, 16); //end position - same as start for zero-discontinuity on cycle
        ...
        private void InitializeStaticCollidableTriangleMeshObjects()
                    {
                        ...
                        transform3D = new Transform3D(new Vector3(-40, 0, 0),
        ...
        private void InitializeStaticCollidableMediumPolyTriangleMeshObjects()
                    {
                        ...
                        transform3D = new Transform3D(new Vector3(-20, 0, 0),
                            new Vector3(0, 0, 0), 0.03f * Vector3.One, Vector3.UnitX, Vector3.UnitY);
        ...
        private void InitializeStaticCollidableLowPolyTriangleMeshObjects()
                    {
                        ...
                        transform3D = new Transform3D(new Vector3(-10, 0, 0),
                            new Vector3(0, 0, 0), 0.03f * Vector3.One, Vector3.UnitX, Vector3.UnitY);
