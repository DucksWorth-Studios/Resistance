...
namespace GDLibrary
{
    ...
    public class BillboardVertexData<T> : BufferedVertexData<T> where T : struct, IVertexType
    {
        ...
        public BillboardVertexData(GraphicsDevice graphicsDevice, T[] vertices, DynamicVertexBuffer vertexBuffer,
        ...
        public BillboardVertexData(GraphicsDevice graphicsDevice, T[] vertices, PrimitiveType primitiveType,
            int primitiveCount)
