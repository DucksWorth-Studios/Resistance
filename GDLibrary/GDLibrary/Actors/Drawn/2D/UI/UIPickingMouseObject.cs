...
namespace GDApp
{
    public class UIPickingMouseObject : UIMouseObject
    {
        ...
        public UIPickingMouseObject(string id, ActorType actorType, Transform2D transform,
            ...
            : this(id, actorType, StatusType.Update | StatusType.Drawn, transform, Color.White, SpriteEffects.None,
                spriteFont,
        ...
        protected virtual void SetAppearance()
        {
            ...
            SourceRectangle = new Rectangle(
                (numberOfReticuleIconsPerTexture - 1) * Texture.Width / numberOfReticuleIconsPerTexture, 0,
                Texture.Width / numberOfReticuleIconsPerTexture, Texture.Height / numberOfReticuleIconsPerTexture);
        }
        ...
        private readonly int numberOfReticuleIconsPerTexture = 1;
        ...
        private void EventDispatcher_ObjectPickChanged(EventData eventData)
        {
            if (eventData.EventType == EventActionType.OnObjectPicked)
            {
                ...
                Text = CollisionUtility.GetMouseStringFromCollidableObject(
                    eventData.AdditionalParameters[0] as CollidableObject, (float) eventData.AdditionalParameters[1]);
            ...
            {
                //see PickingManager::UpdateEventListeners() for publish point
                Text = eventData.AdditionalParameters[0] as string;
